package com.mnnit.secretexposer.helper;
...
public class ReduceImageSize {
    public static File getCompressedImageFile ( File file, Context mContext ) {
        try {
            ...
            if ( getFileExt ( file.getName ( ) ).equals ( "png" ) || getFileExt ( file.getName ( ) )
                    .equals ( "PNG" ) ) {
                o.inSampleSize = 6;
            } else {
                o.inSampleSize = 6;
            ...
            if ( success ) {
                File newFile = new File ( new File ( folder.getAbsolutePath ( ) ), file
                        .getName ( ) );
                if ( newFile.exists ( ) ) {
                    newFile.delete ( );
                }
                ...
                if ( getFileExt ( file.getName ( ) )
                        .equals ( "png" ) || getFileExt ( file.getName ( ) ).equals ( "PNG" ) ) {
